...
def download_excel_files(env_file: Path, output_dir: Path):
    ...
    ba_server_url = env_vars.get("ADDRESSABLE_CATALOG_URL_GL")

    excel_db_url = f"{ba_server_url}/Preload/TableBundles/ExcelDB.db"
    excel_zip_url = f"{ba_server_url}/Preload/TableBundles/Excel.zip"
